            ...
            for req in risk_mgmt.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'high',
                        'severity': 'High',
                        'location': f"Artikel {req.get('sub_article', '9').replace('Art. ', '').replace('Article ', '')}",
            ...
            for req in data_gov.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'high',
                        'severity': 'High',
                        'location': f"Artikel {req.get('sub_article', '10').replace('Art. ', '').replace('Article ', '')}",
            ...
            for req in documentation.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'medium',
                        'severity': 'Medium',
                        'location': f"Artikel {req.get('sub_article', '11-12').replace('Art. ', '').replace('Article ', '')}",
            ...
            for req in oversight.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'high',
                        'severity': 'High',
                        'location': f"Artikel {req.get('sub_article', '14').replace('Art. ', '').replace('Article ', '')}",
            ...
            for req in accuracy.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'high',
                        'severity': 'High',
                        'location': f"Artikel {req.get('sub_article', '15').replace('Art. ', '').replace('Article ', '')}",
            ...
            for req in fria.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'critical',
                        'severity': 'Critical',
                        'location': f"Artikel {req.get('sub_article', '29-35').replace('Art. ', '').replace('Article ', '')}",
            ...
            for req in incident.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'high',
                        'severity': 'High',
                        'location': f"Artikel {req.get('sub_article', '73').replace('Art. ', '').replace('Article ', '')}",
            ...
            for req in national_auth.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'medium',
                        'severity': 'Medium',
                        'location': f"Artikel {req.get('sub_article', '70-72').replace('Art. ', '').replace('Article ', '')}",
