            ...
            for req in risk_mgmt.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'high',
                        'severity': 'High',
                        'location': f"{scan_location} > Risk Management Documentation",
            ...
            for req in data_gov.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'high',
                        'severity': 'High',
                        'location': f"{scan_location} > Training Data Pipeline",
            ...
            for req in documentation.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'medium',
                        'severity': 'Medium',
                        'location': f"{scan_location} > Technical Documentation",
            ...
            for req in oversight.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'high',
                        'severity': 'High',
                        'location': f"{scan_location} > Human Oversight Procedures",
            ...
            for req in accuracy.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'high',
                        'severity': 'High',
                        'location': f"{scan_location} > Model Quality & Testing",
            ...
            for req in fria.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'critical',
                        'severity': 'Critical',
                        'location': f"{scan_location} > Fundamental Rights Impact Assessment",
            ...
            for req in incident.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'high',
                        'severity': 'High',
                        'location': f"{scan_location} > Incident Response Procedures",
            ...
            for req in national_auth.get('requirements', []):
                if not req.get('compliant', True):
                    findings.append({
                        ...
                        'risk_level': 'medium',
                        'severity': 'Medium',
                        'location': f"{scan_location} > Regulatory Compliance",
