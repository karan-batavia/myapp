    ...
    if has_high_risk_ai:
        ...
        if len(missing_qms) >= 2:  # Lower threshold for better detection
            findings.append({
                ...
                'location': 'AI System > Conformity Assessment Documentation',
        ...
        findings.extend([
            {
                ...
                'location': 'AI System > Quality Management System',
            ...
            },
            {
                ...
                'location': 'AI System > Technical Documentation',
            ...
            },
            {
                ...
                'location': 'AI System > Documentation Standards',
            ...
            },
            {
                ...
                'location': 'AI System > Record Keeping',
            ...
            },
            {
                ...
                'location': 'AI System > Automatic Logging',
            ...
            },
            {
                ...
                'location': 'AI System > CE Marking & Compliance Labels',
...
def _detect_enhanced_gpai_compliance(content: str) -> List[Dict[str, Any]]:
    ...
    if has_gpai_model:
        findings.append({
            ...
            'location': 'AI Model > GPAI Model Configuration',
    ...
    if has_high_risk_ai:
        ...
        if missing_monitoring >= 2:
            findings.append({
                ...
                'location': 'AI System > Post-Market Monitoring System',
...
def _detect_transparency_violations(content: str) -> List[Dict[str, Any]]:
    ...
    if has_ai_system and not has_transparency_notice:
        findings.append({
            ...
            'location': 'AI System > User Interface & Transparency',
...
def _detect_algorithmic_accountability(content: str) -> List[Dict[str, Any]]:
    ...
    if has_decision_making and not has_governance:
        findings.append({
            ...
            'location': 'AI System > Governance & Accountability',
    ...
    for violation_type, pattern in monitoring_patterns.items():
        if re.search(pattern, content, re.IGNORECASE):
            findings.append({
                ...
                'location': 'AI System > Monitoring & Reporting',
...
def _detect_automated_risk_classification(content: str) -> List[Dict[str, Any]]:
    ...
    if detected_categories:
        findings.append({
            ...
            'location': 'AI System > Risk Classification',
...
def _detect_quality_management_gaps(content: str) -> List[Dict[str, Any]]:
    ...
    if len(missing_elements) >= 4:
        findings.append({
            ...
            'location': 'AI System > Quality Management',
...
def _detect_automatic_logging_gaps(content: str) -> List[Dict[str, Any]]:
    ...
    if len(missing_logging) >= 3:
        findings.append({
            ...
            'location': 'AI System > Logging Infrastructure',
...
def _detect_human_oversight_gaps(content: str) -> List[Dict[str, Any]]:
    ...
    if len(oversight_gaps) >= 3:
        findings.append({
            ...
            'location': 'AI System > Human Oversight Controls',
...
def _detect_fundamental_rights_gaps(content: str) -> List[Dict[str, Any]]:
    ...
    if len(rights_gaps) >= 4:
        findings.append({
            ...
            'location': 'AI System > Rights Impact Assessment',
    ...
    if has_ai_system:
        ...
        if len(missing_scope) > 2:
            findings.append({
                ...
                'location': 'AI System > Scope & Applicability',
    ...
    if has_ai_system:
        ...
        if len(missing_literacy) > 2:
            findings.append({
                ...
                'location': 'AI System > Training & Literacy Programs',
    ...
    if has_ai_system:
        ...
        if len(missing_definitions) > 2:
            findings.append({
                ...
                'location': 'AI System > General Provisions & Definitions',
    ...
    if has_data_processing:
        ...
        if len(missing_governance) > 2:
            findings.append({
                ...
                'location': 'AI System > Data Governance & Management',
