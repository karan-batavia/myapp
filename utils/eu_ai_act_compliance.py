    ...
    if has_high_risk_ai:
        ...
        if len(missing_qms) >= 2:  # Lower threshold for better detection
            findings.append({
                ...
                'location': 'EU AI Act Articles 19-24 - Conformity Assessment',
        ...
        findings.extend([
            {
                ...
                'location': 'EU AI Act Article 19 - Quality Management',
            ...
            },
            {
                ...
                'location': 'EU AI Act Article 20 - Technical Documentation',
            ...
            },
            {
                ...
                'location': 'EU AI Act Article 21 - Documentation Standards',
            ...
            },
            {
                ...
                'location': 'EU AI Act Article 22 - Record Keeping',
            ...
            },
            {
                ...
                'location': 'EU AI Act Article 23 - Automatic Logging',
            ...
            },
            {
                ...
                'location': 'EU AI Act Article 24 - CE Marking',
...
def _detect_enhanced_gpai_compliance(content: str) -> List[Dict[str, Any]]:
    ...
    if has_gpai_model:
        findings.append({
            ...
            'location': 'EU AI Act Articles 51-55 - GPAI Obligations',
    ...
    if has_high_risk_ai:
        ...
        if missing_monitoring >= 2:
            findings.append({
                ...
                'location': 'EU AI Act Articles 61-68 - Post-Market Monitoring',
...
def _detect_transparency_violations(content: str) -> List[Dict[str, Any]]:
    ...
    if has_ai_system and not has_transparency_notice:
        findings.append({
            ...
            'location': 'EU AI Act Article 13 - Transparency Requirements',
...
def _detect_algorithmic_accountability(content: str) -> List[Dict[str, Any]]:
    ...
    if has_decision_making and not has_governance:
        findings.append({
            ...
            'location': 'EU AI Act Articles 14-15 - Accountability Framework',
...
def _detect_automated_risk_classification(content: str) -> List[Dict[str, Any]]:
    ...
    if detected_categories:
        findings.append({
            ...
            'location': 'EU AI Act Article 6 - System Risk Classification',
...
def _detect_quality_management_gaps(content: str) -> List[Dict[str, Any]]:
    ...
    if len(missing_elements) >= 4:
        findings.append({
            ...
            'location': 'EU AI Act Article 16 - Quality Management System',
...
def _detect_automatic_logging_gaps(content: str) -> List[Dict[str, Any]]:
    ...
    if len(missing_logging) >= 3:
        findings.append({
            ...
            'location': 'EU AI Act Article 17 - Automatic Logging System',
...
def _detect_human_oversight_gaps(content: str) -> List[Dict[str, Any]]:
    ...
    if len(oversight_gaps) >= 3:
        findings.append({
            ...
            'location': 'EU AI Act Article 26 - Human Oversight Framework',
...
def _detect_fundamental_rights_gaps(content: str) -> List[Dict[str, Any]]:
    ...
    if len(rights_gaps) >= 4:
        findings.append({
            ...
            'location': 'EU AI Act Article 29 - Fundamental Rights Framework',
    ...
    if has_ai_system:
        ...
        if len(missing_definitions) > 2:
            findings.append({
                ...
                'location': 'EU AI Act Articles 1-4 - Scope & Definitions',
    ...
    if has_data_processing:
        ...
        if len(missing_governance) > 2:
            findings.append({
                ...
                'location': 'EU AI Act Articles 10-12 - Data Governance Framework',
