...
- **Core Scanning Services**: 12 main scanners (Code, Blob/Document, Image OCR, Website, Database, DPIA, AI Model, SOC2, Sustainability, Audio/Video Deepfake, Enterprise Connector, Repository) plus 5 Repository sub-scanners (Git, Commit, Branch, Tag, Staging, Submodule).
